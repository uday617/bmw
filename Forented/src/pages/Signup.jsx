...
export default function Signup() {
  ...
  const initGoogle = () => {
    ...
    window.google.accounts.id.renderButton(
      ...
      { theme: "filled_black", size: "large", width: 300, text: "signup_with" }
    );
  };
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 900px) {
          ...
          .signup-card { margin: 0 auto !important; padding: 32px 24px !important; }
        }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse 100% 80% at 60% 55%, #180008 0%, #08000e 45%, #030008 100%)",
          zIndex: 0,
        }} />
        ...
        {/* Signup Card */}
        <AnimatePresence>
          <motion.div className="signup-card" style={{
            position: "relative", zIndex: 10, marginLeft: "6vw" ,
          ...
          >
            ...
            {error && (
              <div style={{
                ...
                color: "rgba(255,100,80,1)", fontSize: "12px",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "22px" }}>
              <Field label="Full Name" placeholder="Max Verstappen"
            ...
            <motion.button onClick={handleSignup} disabled={loading}
              style={{
            ...
            >
              {loading ? "Creating Account..." : "Enter the Paddock →"}
            </motion.button>
            ...
            {/* Google Button */}
            <div id="google-btn-signup" style={{ display: "flex", justifyContent: "center" }} />
            ...
            <div style={{
              ...
              <motion.span onClick={() => navigate("/login")}
